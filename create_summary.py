...
if __name__=='__main__':
    ...
    summary_df = pd.DataFrame(columns=['test_case', 'r', 'b', 'd', 'dp_z', 'dp_t', 'mip_z', 'mip_t',  'baseline_z', 'baseline_t', 'heuristics_z', 'heuristics_t'])
    ...
    for filename in sorted(os.listdir("./"+folderName), key = lambda x: int(x.split("_")[1].split(".")[0])):
        ...
        heuristics_z,heuristics_t =solve_heuristics(path,folderName,filename)
